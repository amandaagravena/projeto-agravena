...
##Legenda: Este código remove a geometria espacial dos dados, filtra os pontos pertencentes ao Sistema Costeiro Terrestre e agrupa as observações de XCO₂ por ano e faixa de latitude. A função mutate() cria classes latitudinais a partir das coordenadas, group_by() organiza os dados por ano e latitude e summarise() calcula a média anual de XCO₂ para cada grupo. Por fim, ggplot() gera a visualização da variação temporal do XCO₂, utilizando cores para diferenciar as faixas latitudinais.
